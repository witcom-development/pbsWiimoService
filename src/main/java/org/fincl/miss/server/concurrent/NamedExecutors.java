package org.fincl.miss.server.concurrent;
...
public class NamedExecutors {
    ...
    public static ExecutorService newFixedThreadPool(String name, int nThreads) {
        ...
        return new ThreadPoolExecutor(nThreads, nThreads, 0L, TimeUnit.MILLISECONDS, new LinkedBlockingQueue<Runnable>(), new NamedThreadFactory(name));
    }
