...
public class SEED {
	...
	public static int SeedRoundKey( KISA_SEED_INFO pInfo, KISA_ENC_DEC enc, byte[] pbszUserKey, byte[] pbszIV ) {
		int ABCD[] = new int[4];			// Iuput/output values at each rounds(∞¢ ∂ÛøÓµÂ ¿‘/√‚∑¬)
		int T[] = new int[2];				// Temporary variable
		int K[];
...
/*		byte pbData[]     = {(byte)0x08, (byte)0x09, (byte)0x0A, (byte)0x0B, (byte)0x0C, (byte)0x0D, (byte)0x0E, (byte)0x0F,
	...
	*/	
		String original = "435F00110219B006000000019D204000000001000009090992010500";
		byte pbData[] = DatatypeConverter.parseHexBinary(original);
...
//                (byte)0x08, (byte)0x09, (byte)0x0A, (byte)0x0B, (byte)0x0C, (byte)0x0D, (byte)0x0E, (byte)0x0F};
		...
		int process_blockLeng = BLOCK_SIZE_SEED * 2;								//«—π¯ø° √≥∏Æ«“ BLOCK
		...
		process_blockLeng = BLOCK_SIZE_SEED * 2;								//«—π¯ø° √≥∏Æ«“ BLOCK
