...
public class DHKeyAgreement2 {
    ...
    private void run(String mode) throws Exception {
        ...
        try {
            ...
            System.out.println("bobLen111::" + bobLen);
        }
        ...
        System.out.println("bobLen222::" + bobLen);
        ...
        if (!java.util.Arrays.equals(cleartext, recovered)) throw new Exception("DES in CBC mode recovered text is " + "different from cleartext");
